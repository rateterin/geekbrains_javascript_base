...
catalodList.push(new Item('Кружка', ['./img/Image1.png'], 'Бело-синяя фарфоровая кружка', 95, 20));
catalodList.push(new Item('Ложка', ['./img/Image2.png'], 'Ложка нж', 17));
catalodList.push(new Item('Вилка', ['./img/Image3.png'], 'Вилка серебро', 15));
catalodList.push(new Item('Тарелка', ['./img/Image4.png'], 'Тарелка фарфор', 32, 10));
catalodList.push(new Item('Чайник', ['./img/Image5.png'], 'Чайник нж со свистком', 22));
catalodList.push(new Item('Кастрюля', ['./img/Image6.png'], 'Кастрюля нж ручки пластик', 22, 10));
        ...
        `<div id="item-${id}" class="prod_item">
            <div class='item'>
                ...
                <div class="description">
                    <h4>${item.product}</h4>${item.description}
